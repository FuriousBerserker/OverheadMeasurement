 ...
 *the
 *       code to call separate functions to execute each kernel.  Trivial
 *versions
...
class ShadowMemory {
 ...
 public:
    ...
    unsigned int getAddressOffset(unsigned index) {
        return (unsigned int)(this->bits[index] & 0x0000000000000007);
    }

...
void run()
{
  ...
  if (!output_as_csv)
  {
    ...
    std::cout << std::setprecision(1) << std::fixed
              << "Array size: " << (double)(ARRAY_SIZE*sizeof(T)) / 1024 / 1024 << " MB"
              << " (=" << (double)(ARRAY_SIZE*sizeof(T)) / 1024 / 1024 / 1024 << " GB)" << std::endl;
    std::cout << "Total size: " << (double)(3.0*ARRAY_SIZE*sizeof(T)) / 1024 / 1024 << " MB"
              << " (=" << double(3.0*ARRAY_SIZE*sizeof(T)) / 1024 / 1024 / 1024 << " GB)" << std::endl;
